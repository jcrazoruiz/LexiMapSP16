...
TEST_CASES = [
    ...
    # -------------------------------------------------------------------------
    # CONTROLES RESERVADOS DEL PROTOCOLO
    #
    # Regresión del fallo detectado en held-out:
    # U+0000..U+0003 no deben colisionar con 00 00..00 03.
    # -------------------------------------------------------------------------
    (
        "U+0000 NUL",
        "\x00",
    ...
    (
        "Secuencia U+0000 U+0001",
        "\x00\x01",
    ),
    (
        "Secuencia U+0000 U+0002",
        "\x00\x02",
    ),
    (
        "Secuencia U+0000 U+0003",
        "\x00\x03",
    ),
    (
        "Secuencia reservada actual",
        "\x00\x01\x02\x03",
    ),
    (
    ...
    (
        "Rango completo reservado U+0000..U+000F",
        "".join(chr(value) for value in range(0x00, 0x10)),
    ),
    (
        "Fragmento real con U+0003",
        "ro?\n(O\x03SURIHVRU\x03%XWWV\x03FD\\y\x03SRU\x03HO\x03I",
    ),
